...
def main():
    ...
    while not game_over:
        ...
        while i < 6:
            if (enemy_list[i] >= b_pos[0] and enemy_list[i] <= b_pos[0] + 10) or (
                    b_pos[0] >= enemy_list[i] and b_pos[0] <= enemy_list[i] + enemy_size):
                if (enemy_list[i + 1] >= b_pos[1] and enemy_list[i + 1] <= b_pos[1] + 20) or (
                        b_pos[1] >= enemy_list[i + 1] and b_pos[1] <= enemy_list[i + 1] + enemy_size):
                    enemy_list[i + 1] = 0
